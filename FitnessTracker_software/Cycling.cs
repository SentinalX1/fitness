    ...
    public partial class Cycling : Form
    {
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(textBox1.Text, out int heartrate) &&
                ...
                double.TryParse(textBox3.Text, out double distance) &&
                !string.IsNullOrEmpty(textBox4.Text))
            {
                // Calculate calories burned (you can replace this formula with your own)
                double caloriesBurned = CalculateCaloriesBurned(heartrate,weight, distance);
        ...
        private double CalculateCaloriesBurned(int heartrate, double weight, double distance)
        {
